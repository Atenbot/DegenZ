...
<div className ="px-4 min-h-24 pt-16 md:pt-2 lg:pt-8 lg:pb-24">
    ...
    <h1 className="text-4xl pt-10 text-white mx-auto text-center font-barlow font-extrabold  md:w-[700px] md:pt-28 md:text-5xl md:leading-tight lg:text-6xl lg:w-[900px] lg:leading-[1.2] lg:pt-4 2xl:text-7xl 2xl:w-[1200px]">
