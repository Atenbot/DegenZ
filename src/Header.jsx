...
const Header = () => {
    ...
    <h1 className="text-4xl pt-10 text-white mx-auto text-center font-barlow font-extrabold  md:w-[700px] md:text-5xl md:leading-tight lg:text-6xl lg:w-[900px] lg:leading-[1.2]">
        Facilitating Financial Freedom Through Crypto.
    </h1>
    <button className="header-btn mt-8 w-full py-3 bg-white text-black rounded-xl font-spaceMono font-bold md:w-fit md:px-8 md:text-base lg:mt-8">Join Us </button>
