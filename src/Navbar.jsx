const Navbar = () => {
    return ( 
        ...
        <div className="sticky top-0 bg-primary px-2 z-10 md:px-8 lg:static">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
        <img src="logos\degenz.jpg" className="w-24 h-auto md:w-32 aspect-w-1 aspect-h-1 lg:w-36 2xl:w-48" alt="" />
