...
React.useEffect(() =>{
    ...
    return ( 
        ...
        <div className="pt-16 pb-8 md:pt-20 lg:pt-16 lg:pb-20 xl:pt-24 bg-slate-100">
            <h1 className="font-jersey mx-auto w-[300px] text-4xl font-bold text-center text-secondary md:text-5xl md:w-full lg:text-4xl 2xl:pt-6 2xl:text-6xl 2xl:pb-4">Our Partners and Collaborators</h1>
