...
const Features = () => {
    ...
    return ( 
        <section className="bg-secondary ">
            ...
            <h1 className=" w-[300px] mx-auto text-white font-jersey font-bold text-center text-4xl pt-20 md:w-[600px] md:text-5xl lg:text-left lg:w-[500px] lg:mx-0 xl:text-5xl xl:w-[600px] 2xl:text-6xl 2xl:w-[800px]">Features of DegenZ DAO Membership</h1>
