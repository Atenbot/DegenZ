...
const Features = () => {
    ...
    return ( 
        <section className="bg-secondary pb-4 pt-4 md:pt-10 lg:pt-8 lg:flex lg:px-12 lg:justify-between lg:py-4">
             <h1 className=" w-[300px] mx-auto text-white font-barlow font-bold text-center text-3xl pt-20 md:w-[600px] md:text-4xl lg:text-left lg:w-[500px] lg:mx-0 xl:text-5xl xl:w-[600px]">Features of DegenZ DAO Membership</h1>
            ...
            {accordionData.map((item, index) =>{
                ...
                return(
                                ...
                                <div className="flex items-center justify-between pt-5 w-full"
                                    ...
                                    <ChevronDown className={`w-5 h-5 aspect-auto mt-[2px] md:w-8 md:h-8 md:mt-[6px] lg:w-7 lg:h-7 lg:mb-1.5 ${isActive ? "fill-black md:mb-4 mb-1 lg:mb-[18px]" : "fill-white -rotate-90 mt-0.5 md:mt-0 md:mb-0.5"}`}/>
                                </div>
                               {activeIndex === index && (
                                <div 
