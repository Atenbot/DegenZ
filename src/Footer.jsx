...
const Footer = () => {
    return (  
        ...
        <div className="flex flex-col items-center">
            ...
            <p className="text-white font-barlow text-xs text-center pt-2 tracking-wider md:text-base lg:text-lg">Created By: <span className='underline'>AtenSun_</span></p>
        </div>
        </div>
    );
}
