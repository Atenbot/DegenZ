    ...
    <div className="testimonials lg:pt-24 md:pt-20 bg-white" id="our-story">
      <div className="max-w-7px mx-auto">
        <div className="our-story">
          ...
          <p className="mx-10 max-w-3xl pb-16 text-center pt-6 font-barlow leading-normal text-secondary text-lg  md:text-lg md:mx-14 md:pb-24 md:pt-6 lg:mx-auto lg:text-xl lg:max-w-[700px] lg:pb-24 2xl:text-2xl 2xl:max-w-5xl 2xl:pt-8">
